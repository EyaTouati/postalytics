...
class DimDestination(Base):
    ...
    pays_dest = Column(String(100), nullable=False)
    ville_dest = Column(String(100), nullable=True)
    cite_dest = Column(String(100), nullable=True)
    code_postal_dest = Column(String(20), nullable=True)
