        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          <div className="mt-6 pt-5 border-t border-surface-muted">
            ...
            <div className="grid grid-cols-2 gap-2">
              {[
                { label: "Admin", username: "admin", password: "Admin@2024" },
                { label: "Responsable", username: "responsable", password: "Responsable@2024" },
                { label: "Agent Tunis", username: "agent_tunis", password: "Agent@2024" },
                { label: "Agent Sfax", username: "agent_sfax", password: "Agent@2024" },
              ].map((c) => (
                <button
                  key={c.username}
